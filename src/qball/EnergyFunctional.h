...
public:
    ...
    ChargeDensity *hamil_cd() {
        return hamil_cd_;
    } ;   // AS: specifies the density used for setting up the Hamiltonian
...
>>>>>>> d1404658dd09b4a711e980f4f56c96100e105838
    ...
    double ekin(void) const {
        return ekin_;
    }
    double econf(void) const {
        return econf_;
    }
    double eps(void) const {
        return eps_;
    }
    double enl(void) const {
        return enl_;
    }
    double ehart(void) const {
        return ehart_;
    }
    double ecoul(void) const {
        return ecoul_;
    }
    double exc(void) const {
        return exc_;
    }
    double evdw(void) const {
        return evdw_;
    }
    double esr(void) const {
        return esr_;
    }
    double eself(void) const {
        return eself_;
    }
    double ets(void) const {
        return ets_;
    }
    double epv(void) const {
        return epv_;
    }
    double eexf(void) const {
        return eexf_;
    }
    double ehub(void) const {
        return ehub_;
    }
    double eharris(void) const {
        return eharris_;
    }
    double etotal_harris(void) const {
        return (ekin_ + econf_ + enl_ + ets_ + epv_ + ehub_ + eharris_ + esr_ - eself_);
    };
    double casino_ewald(void);
    double casino_vloc(void);
    const ConfinementPotential *confpot(int ispin, int ikp) const {
        return cfp[ispin][ikp];
    }
